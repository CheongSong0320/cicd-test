...
import { CommunityClubSeat, CommunityClubTimeInterval } from '@prisma/client';

export class CommunityClubSeatDto implements CommunityClubSeat {
    static from(value: CommunityClubSeat) {
        return new CommunityClubSeatDto(value);
    }
