import { CommunityClub, CommunityClubPerson, CommunityClubSeat, CommunityClubTimeLimit, CommunityClubType } from '@prisma/client';

export type RegisterCommunityBody = IRegisterCommunityPersonType | IRegisterCommunitySeatType | IRegisterCommunityTimeLimitSeatType;
...
export class IRegisterCommunityTimeLimitSeatType {
    communityClub: Omit<CommunityClub, 'id' | 'apartmentId'>;
    communityClubTimeLimit: Omit<CommunityClubTimeLimit, 'id' | 'community_club_id'>;
    type: typeof CommunityClubType['SEAT_TIME_LMIT'] | typeof CommunityClubType['PERSON_TIME_LIMIT'];
}
