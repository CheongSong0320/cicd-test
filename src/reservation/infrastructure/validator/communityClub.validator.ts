...
export class CommunityClubValidator {
    registerCommunityClubValidator(body: RegisterCommunityBody, apartmentId: number, image: string | undefined) {
        return Prisma.validator<Prisma.CommunityClubCreateArgs>()({
            data: {
                ...body.communityClub,
                image,
                apartmentId,
                CommunityClubPerson: body.type === 'PERSON' ? { create: body.communityClubPerson } : undefined,
                CommunityClubSeat: body.type === 'SEAT' ? { create: body.communityClubSeat } : undefined,
                CommunityClubTimeLimit: body.type === 'SEAT_TIME_LMIT' || body.type === 'PERSON_TIME_LIMIT' ? { create: body.communityClubTimeLimit } : undefined,
            },
            include: {
